...
#define MAX_DATA_SIZE 4096 /*This was 5, so recv buff might have been huge(up to 4096 as defined by max size on client side) but when copied to str which was only size 5 you had a buffer overflow! Huzzaaah */
